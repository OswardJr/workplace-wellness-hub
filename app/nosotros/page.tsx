...
export const metadata: Metadata = {
  title: "Sobre Nosotros | Trainermax – Bienestar Laboral y Pausas Activas en Perú",
  description: "Conoce la historia, equipo y enfoque de Trainermax. Más de 9 años promoviendo pausas activas, gimnasia laboral y bienestar en empresas de Perú.",
  keywords: "sobre trainermax, empresa pausas activas peru, equipo bienestar laboral, historia trainermax",
  openGraph: {
    type: "website",
    url: "https://luistrainermax.com/nosotros",
    title: "Sobre Nosotros | Trainermax – Bienestar Laboral en Perú",
    description: "Más de 9 años promoviendo pausas activas, gimnasia laboral y bienestar en empresas de Perú.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Sobre Nosotros | Trainermax",
    description: "Conoce el equipo y la historia de la empresa líder en bienestar laboral en Perú.",
    images: ["https://luistrainermax.com/lovable-uploads/logo_trainer.png"]
  },
  alternates: {
    canonical: "https://luistrainermax.com/nosotros"
  }
};
